...
# Import all models to migrate via apps.models (add/remove in apps/models.py for private projects)
import apps.models  # noqa: F401

config = context.config

# Get database URL from settings and convert to sync driver (Alembic uses pymysql, not aiomysql)
# Use attributes to avoid ConfigParser interpolation issues
